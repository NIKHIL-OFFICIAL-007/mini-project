...
if ($_POST) {
    ...
    // Validate inputs
    if (empty($name) || !$email || empty($password) || empty($confirm_password)) {
...
<head>
  ...
  <title><?= htmlspecialchars($site_settings['site_name']) ?> - Register</title>
...
<body class="p-4">
  <div class="glass-card text-white overflow-hidden">
    ...
    <!-- Form -->
    <form method="POST" class="p-6 space-y-4" id="registerForm">
      <div>
      ...
      <div>
        ...
        <div id="confirmPasswordSuccess" class="success-text hidden">✓ Passwords match</div>
      </div>
