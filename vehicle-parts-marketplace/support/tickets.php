...
// Fetch ALL tickets from buyers and sellers with unread count
$tickets = [];
try {
    $stmt = $pdo->prepare("
...
<body class="bg-gray-50 text-gray-900">
  ...
  <div class="py-12 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <p class="text-blue-100 max-w-2xl mx-auto text-lg">Manage all customer and seller support requests.</p>
    </div>
  </div>
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900">
              <?= array_sum(array_column($tickets, 'unread_replies')) ?>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
      <div class="bg-gradient-to-r from-blue-50 to-cyan-50 px-6 py-5 border-b border-blue-100">
        ...
        <p class="text-gray-600 mt-1 text-sm">View and respond to all buyer and seller tickets.</p>
      </div>
                ...
                <tr class="hover:bg-gray-50 <?= $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' ?>">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center">
                      ...
                      <?php if (($ticket['unread_replies'] ?? 0) > 0): ?>
                        <span class="bg-red-500 text-white text-xs px-2 py-1 rounded-full ml-2"><?= (int)$ticket['unread_replies'] ?></span>
                      <?php endif; ?>
                    </div>
                  </td>
                  <td class="px-6 py-4">
